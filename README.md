...
Para que você consiga fazer a manipulação de arrquivos, é necessário o uso do `System.IO`, com ele é possível ter controle sobre os arquivos que serão criados ou lidos
